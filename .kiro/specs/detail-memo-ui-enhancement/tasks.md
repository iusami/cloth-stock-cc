...
- [ ] 6. SwipeableDetailPanel スワイプジェスチャー機能の実装（TDD）
- [ ] 6.1 スワイプジェスチャー検出のユニットテスト作成
...
- [ ] 7. SwipeableDetailPanel アニメーション機能の実装（TDD）
- [ ] 7.1 パネルアニメーションのユニットテスト作成
...
- [ ] 9. デバイス対応とパフォーマンス最適化の実装（TDD）
- [ ] 9.1 デバイス対応機能のユニットテスト作成
